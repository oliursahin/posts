...
await import('./chunks/astro/env-setup_CbjfZWeG.mjs').then(n => n.d).then((mod) => mod.setGetEnv((key) => process.env[key])).catch(() => {
});
apply();
...
const _args = {
    "middlewareSecret": "37951837-7479-4f8e-9fe8-fe92719f852a",
